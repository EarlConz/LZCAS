-- ═══════════════════════════════════════════════════════════════════
-- Migration v14 — Upgrade requires a login account
--   Packages are linked to reseller *accounts*: availing one makes the
--   member a Verified Reseller who logs in with reseller access. Block
--   the upgrade server-side when the member has no profiles (login) row,
--   so the rule holds even if a client guard is bypassed.
-- Supersedes the body of migration_v13_upgrade_promotes_reseller.sql.
