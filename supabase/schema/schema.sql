...
-- Saved member location (v47) — mirrors the profiles location columns so a
-- Member (Buyer) can save a default location. `address` already exists on
-- `members` (its home/mailing address) and is reused for the saved
-- location's reverse-geocoded string, exactly as `profiles.address` is for
-- cashiers. All nullable so pre-existing rows keep working unchanged.
...
-- ===========================================================================
-- MEMBER ORDERING & DELIVERY NEGOTIATION (v48) — variable item pricing +
-- negotiable delivery fee. See migrations/migration_v48_delivery_orders.sql.
-- ===========================================================================
