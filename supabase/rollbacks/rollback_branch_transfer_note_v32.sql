-- rollback_branch_transfer_note_v32.sql
-- Reverts migration_v32: restores the v31 functions whose Reports reason is the
-- branch name only (no note appended). Equivalent to re-running
