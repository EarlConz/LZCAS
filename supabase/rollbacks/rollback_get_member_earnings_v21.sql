-- ═══════════════════════════════════════════════════════════════════
-- ROLLBACK for migration_v22_chairman_per_referral.sql
--
-- This is the get_member_earnings function EXACTLY as it ran in production
-- before v22 (v21 behavior: Chairman's Bonus = rate × (1 + Fridays elapsed) —
-- an immediate payment on availment/upgrade plus a weekly Friday payout).
-- If v22 needs to be undone, run this file — it restores the pre-v22 behavior.
