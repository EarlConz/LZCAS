-- ═══════════════════════════════════════════════════════════════════
-- ROLLBACK for migration_v23_chairman_immediate_per_referral.sql
--
-- This is the get_member_earnings function EXACTLY as it ran in production
-- before v23 (v22 behavior: Chairman's Bonus = per payout Friday, referrals
-- that week × the chairman rate of the package held ON that Friday, counting
-- only Fridays that have already passed).
-- If v23 needs to be undone, run this file — it restores the pre-v23 behavior.
