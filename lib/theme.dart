...
final stockpileTheme = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    surfaceContainerHigh: const Color(0xFFE5E5E9),
    surfaceContainerHighest: const Color(0xFFDFDFE3),
...
final stockpileDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    surfaceContainerLowest: const Color(0xFF13131E),
    surfaceContainerLow: const Color(0xFF181828),
    surfaceContainer: const Color(0xFF1D1D30),
    surfaceContainerHigh: const Color(0xFF222238),
    surfaceContainerHighest: const Color(0xFF272740),
